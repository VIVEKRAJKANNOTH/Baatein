...
function App() {
  ...
  return (
    <div className="min-h-screen bg-indigo-950 text-white overflow-hidden relative selection:bg-teal-500/30">
      ...
      {/* Background Ambience */}
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_50%,rgba(42,157,143,0.1),transparent_50%)] animate-pulse duration-[10000ms] pointer-events-none" />

      <TopBar />

      <main className="flex flex-col items-center justify-between min-h-screen relative z-10 px-6 py-16 gap-8 md:gap-16">
        ...
        {/* Controls */}
        <div className="pb-6 flex flex-col items-center gap-4 relative z-50">
